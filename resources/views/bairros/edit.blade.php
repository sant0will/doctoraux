...
@section('content_header')
	<p class="header-title">Editor de Bairros</p>
@stop   
    ...
    <div class="row">
		<div class="col-md-10 col-md-offset-1">
			<div class="box box-primary">
				...
				<form class="form-horizontal" method="POST" action="{{action('BairroController@update', $bairro->id)}}">
                     @csrf				
					...
					<div class="box-body">
						<div class="form-group has-feedback {{ $errors->has('nome') ? 'has-error' : '' }}">
							...
							<div class="col-sm-10">
                            <input type="text" class="form-control" name="nome" value="{{$bairro->nome}}" placeholder="" minlength="2" maxlength="45" required>
							</div>
						</div>
