...
@section('content_header')
    <p class="header-title">Cadastro de Estados</p>
@stop
    ...
    <div class="row">
		<div class="col-md-10 col-md-offset-1">
			<div class="box box-primary">
				...
				<form class="form-horizontal" method="post" action="{{url('/estados')}}">
					@csrf
					...
					<div class="box-body">
						...
						<div class="form-group has-feedback {{ $errors->has('uf') ? 'has-error' : '' }}">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" name="uf" id="uf" value="" placeholder="" minlength="2" maxlength="2" onkeyup="validateUF()" required>
