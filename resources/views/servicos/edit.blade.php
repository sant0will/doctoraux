...
@section('content_header')
	<p class="header-title">Cadastro de Serviço</p>
@stop
    ...
    <div class="row">
		<div class="col-md-10 col-md-offset-1">
			<div class="box box-primary">
				...
				<form class="form-horizontal" method="post" action="{{action('CadastroServicoController@update', $id)}}">
					@csrf
					...
					<div class="box-body">
						...
						<div class="form-group has-feedback {{ $errors->has('descricao') ? 'has-error' : '' }}">
							...
							<div class="col-sm-10">
                                <input type="text" class="form-control" value="{{$servico->descricao}}" name="descricao" placeholder="" minlength="3" maxlength="45" required>
