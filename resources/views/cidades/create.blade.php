...
@section('content_header')
	<p class="header-title">Cadastro de Cidades</p>
@stop
    ...
    <div class="row">
		<div class="col-md-10 col-md-offset-1">
			<div class="box box-primary">
				...
				<form class="form-horizontal" method="post" action="{{url('/cidades')}}">
					@csrf
					...
					<div class="box-body">
						...
						<div class="form-group has-feedback {{ $errors->has('nome') ? 'has-error' : '' }}">
							<label for="nome" class="col-sm-2 control-label">Nome da Cidade *</label>
							<div class="col-sm-10">
