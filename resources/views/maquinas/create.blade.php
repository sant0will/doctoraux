    ...
    <div class="row">
		<div class="col-md-10 col-md-offset-1">
			<div class="box box-primary">
				...
				<form class="form-horizontal" method="post" action="{{url('/maquinas')}}">
					@csrf
					...
					<div class="box-body">
                        ...
                        <div class="form-group has-feedback {{ $errors->has('codigo_frota') ? 'has-error' : '' }}">
							...
							<div class="col-sm-10">
                                <input type="emais" class="form-control" value="{{old('codigo_frota')}}" name="codigo_frota" id="codigo_frota" placeholder="" minlength="1" maxlength="45" required>
                        ...
                        <div class="form-group has-feedback {{ $errors->has('valor') ? 'has-error' : '' }}">
							...
							<div class="col-sm-10">
                                <input type="text" class="form-control" value="{{old('valor')}}" name="valor" id="valor" placeholder="" minlength="1" maxlength="14" required>
                                @if ($errors->has('valor'))
                                    <span class="help-block">
